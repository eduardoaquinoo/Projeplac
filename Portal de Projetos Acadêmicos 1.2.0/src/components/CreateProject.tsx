...
import { saveNewProject } from "../utils/projectsManager";
...
export function CreateProject({ onBack }: CreateProjectProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Salvar projeto com status "Em Revisão"
    const newProject = saveNewProject({
      ...
      tags: formData.tags,
      authorId: currentUser.username || currentUser.ra || currentUser.email,
      authorName: currentUser.name,
      course: currentUser.course || "Não especificado"
    });
    
    console.log("Projeto criado:", newProject);
    alert("Projeto enviado com sucesso! Ele está em revisão e será publicado após aprovação do administrador.");
