...
import { deleteProject } from "../utils/projectsManager";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function ProjectDetails({ onBack, projectId, isAdmin = false }: ProjectDetailsProps) {
  ...
  const handleConfirmDelete = () => {
    ...
    if (success) {
      ...
      onBack(); // Volta para a página anterior após excluir
    }
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tem certeza que deseja excluir este projeto? Esta ação não pode ser desfeita e o projeto será removido permanentemente.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
