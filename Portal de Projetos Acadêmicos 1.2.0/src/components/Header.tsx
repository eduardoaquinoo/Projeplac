...
import { Search, Menu, User, LogOut, Home, FolderOpen, UserCircle, LayoutDashboard } from "lucide-react";
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              {isLoggedIn ? (
                <>
                  {/* Botão Gerenciar - Apenas para Admin */}
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-48">
                      {/* Opção Gerenciar - Apenas para Admin */}
                      {isAdmin && onNavigateToAdminDashboard && (
                        <>
                          <DropdownMenuItem onClick={onNavigateToAdminDashboard}>
                            <LayoutDashboard className="h-4 w-4 mr-2" />
                            Gerenciar Projetos
                          </DropdownMenuItem>
