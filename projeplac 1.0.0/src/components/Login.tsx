...
export function Login({ onBack, onLoginSuccess, onNavigateToRegister }: LoginProps) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Verifica credenciais do usuário teste
    if (formData.username === "24686" && formData.password === "123456") {
      alert("Login realizado com sucesso!");
      onLoginSuccess();
    } else {
      setError("Usuário ou senha incorretos. Tente: RA: 24686, Senha: 123456");
    }
