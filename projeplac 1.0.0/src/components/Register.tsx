...
import { ArrowLeft, UserPlus, User, GraduationCap, Clock, Calendar, Lock, Mail, Phone, BookOpen } from "lucide-react";
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <Card className="border-primary/20">
          <CardHeader className="text-center">
            <CardTitle className="text-primary">Cadastro de Estudante</CardTitle>
            <CardDescription>
            ...
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Data deve estar entre 1940 e 2010
                </p>
              </div>
        ...
        <div className="mt-8 p-6 bg-accent rounded-lg border border-accent-foreground/20">
          ...
          <ul className="text-sm text-accent-foreground/80 space-y-1">
            <li>• Portal exclusivo para estudantes da UNICEPLAC</li>
